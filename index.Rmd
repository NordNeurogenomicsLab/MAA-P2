...
## 5.1 GO BP Upregulated P < 0.05
```{r}
datatable(arrange(GO_BP_up_En[[1]], classicFisher), rownames = FALSE, filter="top", options = list(pageLength = 15, scrollX=T))

```

## 5.2 GO BP Downregulated P < 0.05
```{r}
datatable(arrange(GO_BP_down_En[[1]], classicFisher), rownames = FALSE, filter="top", options = list(pageLength = 15, scrollX=T))
...
#
GO_BP_up_UCSC_FDR_02 <- GO_analysis_FDR_02(glm.output.full_En, "upregulated", 4675)
GO_BP_down_UCSC_FDR_02 <- GO_analysis_FDR_02(glm.output.full_En, "downregulated", 4675)


```

## 5.3 GO BP Upregulated FDR < 0.2
```{r}
datatable(arrange(GO_BP_up_UCSC_FDR_02[[1]], classicFisher), rownames = FALSE, filter="top", options = list(pageLength = 15, scrollX=T))

```


## 5.4 GO BP Downregulated FDR < 0.2
```{r}
datatable(arrange(GO_BP_down_UCSC_FDR_02[[1]], classicFisher), rownames = FALSE, filter="top", options = list(pageLength = 15, scrollX=T))
